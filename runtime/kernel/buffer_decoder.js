...
import {POLYFILL_TEXT_ENCODING, checkCriticalPositionIndex, checkCriticalState, checkState} from "../internal/checks.js";
import {byteStringFromUint8ArrayUnsafe} from "../bytestring_internal.js";
import {concatenateByteArrays} from "./uint8arrays.js";
import {decode} from "./textencoding.js";
...
function getStringDecoderFunction() {
  ...
  if (self['TextDecoder']) {
    ...
    const textDecoder = new self['TextDecoder']('utf-8', {fatal: true});
