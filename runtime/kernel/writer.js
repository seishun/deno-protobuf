...
import {POLYFILL_TEXT_ENCODING, checkFieldNumber, checkTypeUnsignedInt32, checkWireType} from "../internal/checks.js";
import {concatenateByteArrays} from "./uint8arrays.js";
import {encode} from "./textencoding.js";
...
function getEncoderFunction() {
  ...
  if (self['TextEncoder']) {
    ...
    const textEncoder = new self['TextEncoder']('utf-8');
